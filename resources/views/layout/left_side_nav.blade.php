                ...
                @can('global.setting.index')
                    <div data-kt-menu-trigger="click"
                         class="menu-item menu-accordion
                            ...
                            {{ Request::route()->getName() == 'privacy.policy.index' ? 'show' : '' }}
                            {{ Request::route()->getName() == 'privacy.policy.create' ? 'show' : '' }}
                            {{ Request::route()->getName() == 'privacy.policy.edit' ? 'show' : '' }}
                            {{ Request::route()->getName() == 'term.condition.index' ? 'show' : '' }}
                            {{ Request::route()->getName() == 'term.condition.edit' ? 'show' : '' }}
                            ">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item menu-accordion mb-1">
                                    ...
                                    <a href="{{ route('privacy.policy.index') }}"
                                       class="menu-link
                            {{ Request::route()->getName() == 'privacy.policy.index' ? 'active' : '' }}
                            {{ Request::route()->getName() == 'privacy.policy.create' ? 'active' : '' }}
                            {{ Request::route()->getName() == 'privacy.policy.edit' ? 'active' : '' }} ">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('privacy_policy') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
                        ...
                        @endcan
                        @can('term.condition.index')
                            <div class="menu-sub menu-sub-accordion">
                                <!--begin:Menu item-->
                                <div class="menu-item menu-accordion mb-1">
                                    <!--begin:Menu link-->
                                    <a href="{{ route('term.condition.index') }}"
                                       class="menu-link
                            {{ Request::route()->getName() == 'term.condition.index' ? 'active' : '' }}
                            {{ Request::route()->getName() == 'term.condition.edit' ? 'active' : '' }} ">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('term_and_condition') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->

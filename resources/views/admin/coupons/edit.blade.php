                ...
                <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">{{ __('edit_coupon') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container">
                    ...
                    <form class="form d-flex flex-column flex-lg-row" method="POST" enctype="multipart/form-data"
                        action="{{ route('coupon.update', $coupon->slug) }}">
                        @csrf
                                ...
                                <div class="card-body row pt-0">
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="slug" class="form-control"
                                            placeholder="{{ __('enter_slug') }}" value="{{ old('slug', $coupon->slug) }}">
                                        @if ($errors->has('slug'))
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="code" class="form-control"
                                            placeholder="{{ __('enter_unique_code') }}"
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="date" name="expiry_date" class="form-control"
                                            placeholder="{{ __('enter_expiry_date') }}"
                                    ...
                                    <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                        ...
                                        <textarea name="description" class="kt_docs_ckeditor_classic">{{ old('description', $coupon->description) }}</textarea>
                                    ...
                                    <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                        ...
                                        <input class="form-check-input mt-3" type="checkbox"
                                            name="enabled"{{ $coupon->enabled == 1 ? 'checked' : '' }} />

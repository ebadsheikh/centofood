@php use App\Enums\CategoryEnum;use App\Enums\FoodsEnum;use App\Enums\RestaurantEnum;use Carbon\Carbon; @endphp
...
@section('content')
    ...
    <section class="p-0 small-slider">
        <div class="slider-animate home-slider">
            <div>
                <div class="home">
                    <img src="{{ asset('website/assets/images/bgg.jpg') }}" alt=""
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain product-detail">
                                    <div>
                                        <h4 class="animated" data-animation-in="fadeInUp">{{ __('moods_of_the_earth') }}
                                        </h4>
                                        <h1 class="animated" data-animation-in="fadeInUp" data-delay-in="0.3">
                                            {{ __('trending_products') }}</h1>
                                        <p class="animated d-lg-block d-none" data-delay-in="0.4"
                                           data-animation-in="fadeInUp">
                                            ...
                                            sapphires</p>
                                        <a href="{{ route('category.show') }}" class="btn btn-solid animated rounded-3"
                                           data-animation-in="fadeInUp" data-delay-in="0.5">{{ __('shop_now') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="vegetables-category">
        <div class="container">
            <div class="row g-4 justify-content-start">
                @livewire('category-box',['callFrom' => CategoryEnum::CATEGORY_SECTION_HOME_PAGE->value])
            </div>
        </div>
    </section>
                        ...
                        <div class="col-lg-4">
                            <a href="#">
                                <div class="collection-banner p-right text-end">
                                    <div class="img-part">
                                        <img
                                            src="{{ asset('website/assets/images/dashboard/product/1.jpg') }}"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>

                                    <div class="contain-banner white-content banner-3">
                                        <div>
                                            <h4>{{ $coupon['discount_type_id'] == $discountType['id'] ? $discountType['name'] : '' }}
                                            </h4>
                                            <h2 class="mb-1">{{ __('discount') }}: {{ $coupon['discount'] }}</h2>
                                            <h6 class="mb-0">{{ __('valid_till') }}
                                                {{ Carbon::parse($coupon->expiry_date)->diffForHumans() }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </a>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="title8">
                        ...
                        <p>{{ __('delicious_cuisine_served_fresh.') }}</p>
                    </div>
                </div>
                <div class="text-end col-6 mb-1">
                    <a href="{{ route('restaurant.show') }}" class="btn btn-solid"
                       id="mc-submit">{{ __('see_all') }}</a>
                </div>
                <div class="row g-4 gap-4 justify-content-start">
                    @livewire('restaurant-box',['callFrom' => RestaurantEnum::RESTAURANT_SECTION_HOME_PAGE->value])
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bag-product ratio_square">
        <div class="container">
            <div class="row">
                ...
                <div class="row g-4 gap-4 justify-content-start">
                    @livewire('food-box',['callFrom' => FoodsEnum::FOOD_SECTION_HOME_PAGE->value])
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bag-product ratio_square deal-product-space section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="title8">
                        <h2>{{ __('lowest_price') }}</h2>
                        <p>{{ __('delicious_foods_at_cheapest_price') }}</p>
                    </div>
                </div>
                <div class="row g-4 gap-4 justify-content-start">
                    @livewire('cheap-food-box',['callFrom' => FoodsEnum::FOOD_SECTION_HOME_PAGE->value])
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="col-lg-3 col-sm-6 service-block">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4>{{ __('free_shipping') }}</h4>
                                <p>{{ __('free_shipping_world_wide') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 service-block">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>{{ __('online_service_for') }} 24 X 7</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 service-block">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4>{{ __('festival_offer') }}</h4>
                                <p>{{ __('super_sale_upto_50%_off') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 service-block">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <ul class="comment-section">
                        <li>
                            <div class="media"><img src="{{ asset('website/assets/images/avtar.jpg') }}"
                        ...
                        <li>
                            <div class="media"><img src="{{ asset('website/assets/images/2.jpg') }}"
                                                    alt="Generic placeholder image">
                                <div class="media-body">
                                    <h6>Mark Jecno <span>( 12 Jannuary 2018 at 1:30AM )</span></h6>
                                    <p>Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis

                ...
                <div class="dashboard-sidebar">
                    <div class="profile-top">
                        <div class="profile-image">
                            <img src="{{asset('assets/website/assets/images/avtar.jpg')}}" alt="" class="img-fluid">
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="counter-box">
                                        <img src="{{asset('assets/website/assets/images/icon/dashboard/sale.png')}}" class="img-fluid">
                                        <div>
                                            <h3>25</h3>
                                            <h5>Total Order</h5>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="counter-box">
                                        <img src="{{asset('assets/website/assets/images/icon/dashboard/homework.png')}}" class="img-fluid">
                                        <div>
                                            <h3>5</h3>
                                ...
                                <div class="col-md-4">
                                    <div class="counter-box">
                                        <img src="{{asset('assets/website/assets/images/icon/dashboard/order.png')}}" class="img-fluid">
                                        <div>
                                            <h3>50</h3>
                                            <h5>Wishlist</h5>
                                        </div>
                                            ...
                                            <table class="table cart-table order-table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <a href="javascript:void(0)">
                                                                <img src="{{asset('assets/website/assets/images/pro3/1.jpg')}}"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="javascript:void(0)">
                                                                <img src="{{asset('assets/website/assets/images/pro3/2.jpg')}}"
                                                                    class="blur-up lazyloaded" alt="">
                                                            </a>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="javascript:void(0)">
                                                                <img src="{{asset('assets/website/assets/images/pro3/27.jpg')}}"
                                                                    class="blur-up lazyloaded" alt="">
                                                            </a>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="javascript:void(0)">
                                                                <img src="{{asset('assets/website/assets/images/pro3/28.jpg')}}"
                                                                    class="blur-up lazyloaded" alt="">
                                                            </a>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="javascript:void(0)">
                                                                <img src="{{asset('assets/website/assets/images/pro3/33.jpg')}}"
                                                                    class="blur-up lazyloaded" alt="">
                                                            </a>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="javascript:void(0)">
                                                                <img src="{{asset('assets/website/assets/images/pro3/34.jpg')}}"
                                                                    class="blur-up lazyloaded" alt="">
                                                            </a>
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="address-book-section">
                                            <div class="row g-4">
                                                <div class="select-box active col-xl-4 col-md-6">
                                                    <div class="address-box">
                                                        <div class="bank-logo">
                                                            <img src="{{asset('assets/website/assets/images/bank-logo.png')}}"
                                                                class="bank-logo">
                                                ...
                                                <div class="select-box col-xl-4 col-md-6">
                                                    <div class="address-box">
                                                        <div class="bank-logo">
                                                            <img src="{{asset('assets/website/assets/images/bank-logo1')}}.png"
                                                                class="bank-logo">
                                                            <img src="{{asset('assets/website/assets/images/visa.png')}}"
                                                                class="network-logo">
                                                        </div>
                                                        <div class="card-number">
                                                            <h6>Card Number</h6>

...
class FileManagerController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        try {
            ...
            if ($file) {
                return redirect()->route('file.index')->withSuccess(__('file_created_successfully'));
            } else {
    ...
    public function upload(Request $request): JsonResponse
    {
        try {
            ...
            return back()->withError('something_went_wrong!');
        }
    }
    ...
    public function destroy($id): RedirectResponse
    {
        try {
            ...
            if ($is_deleted) {
                return back()->withSuccess(__('file_deleted_Successfully'));
            } else {
                return back()->withError(__('something_went_wrong!'));
            }
        } catch (Exception $ex) {

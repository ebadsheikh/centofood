...
class RestaurantController extends Controller
{
    ...
    public function show(): View
    {
        ...
        return view('frontend.restaurants.index')->with('restaurants', $restaurants);
    }

    /**
     * Show the profile for a resource.
     *
     * @param Restaurant $restaurant
     * @return View
     */
    public function profile(Restaurant $restaurant): View
    {
        $foods = Food::all();

        return view('frontend.restaurants.profile')->with(['restaurant' => $restaurant, 'foods' => $foods]);
    }

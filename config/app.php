...
return [
    ...
    */
    ...
    'domain' => env('APP_DOMAIN', 'centofood.com'),
    ...
    */
    ...
    'aliases' => Facade::defaultAliases()->merge([
        ...
        'FakerHelper' => App\Helpers\FakerHelper::class,
        'TranslateTextHelper' => App\Helpers\TranslateTextHelper::class,
        'ImageHelper' => App\Helpers\ImageHelper::class,
        'EmailConfigHelper' => App\Helpers\EmailConfigHelper::class,
    ])->toArray(),
